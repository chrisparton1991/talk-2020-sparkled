...
class MeIn2006Slide extends Slide {
  ...
  public async init() {
    ...
    const meIn2006 = await this.build.image(meIn2006Sprite, fromStart(0), fromEnd(0), .5);
    this.add(meIn2006);

    const firstPc = await this.build.image(firstPcSprite, fromStart(500), fromEnd(0), .321);
    this.add(firstPc);
